...
import ViewStudentInfo from '../../../components/Admin/Demography/ViewStudentInfoProfile';
  ...
  return (
    <Fragment>
      ...
      <AppBar className="app-header" color="secondary" position="fixed">
          <Toolbar>
            <IconButton edge="start" color="inherit" onClick={()=>this.props.history.push("/admin/dashboard")} aria-label="close">
              <CloseIcon />
            </IconButton>
