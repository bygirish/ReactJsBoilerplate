...
import AddStaff from '../../../components/Admin/Demography/AddStaff';
      ...
      <Grid container spacing={4} justify="center" className="sliderDiv">
        <Grid item xs={12} lg={8}>
          <div  className="pt-100">   
            <AddStaff title={this.headerTitle} {...this.props} />
          </div>
        </Grid>
      </Grid>
      </Animated>
...
export default connect(mapStateToProps, mapDispatchToPros)(Staff);