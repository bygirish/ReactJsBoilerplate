...
import ViewStudentInfo from '../../../components/Admin/Demography/ViewStaffInfo';
  ...
  return (
    <Fragment>
      ...
      <AppBar className="app-header" color="secondary" position="fixed">
          <Toolbar>
            <IconButton edge="start" color="inherit" onClick={()=>this.props.history.push("/admin/view-staff")} aria-label="close">
              <CloseIcon />
            </IconButton>
