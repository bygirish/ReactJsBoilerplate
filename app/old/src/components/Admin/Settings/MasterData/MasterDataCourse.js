...
class Student extends React.Component {
    ...
    insertMaster = () => {
        ...
        let endpoint = "AcademicSettings/insertCourseMasterInfo";
                                ...
                                <Grid item xs={12} sm={12} lg={8}>
                                    ...
                                    <Card className="card-box  mb-3 mt-2 p-3">
                                        <Grid container justify="center">
                                            ...
                                            <Grid item xs={12} md={4} lg={4} className=" my-2 px-2 pt-1 pb-3"></Grid>
                                                    ...
                                                    <Grid item xs={12} sm={12} lg={12} className="customChip">
                                                        <FormControl fullWidth>
                                                            <ChipInput
                                                                variant="outlined"
                                                                className="inputTag"
                                                                label={"Add Course and press 'Enter'"}
