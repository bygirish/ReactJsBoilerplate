...
class Student extends React.Component {
  ...
  return (
    ...
    <PageTitle
        ...
        titleHeading="Course Management"
        titleDescription=""
        {...this.props}
      /> 
      ...
      {AuthHelper('Course Management','can_create') &&    <Grid container spacing={2} justify="center">
        <Grid item xs={12} sm={12} lg={4}></Grid>
        <Grid item xs={12} sm={12} lg={4}>
          <Button className="m-2 w-100 py-2 font-18" variant="contained" color="secondary" onClick={()=>this.props.history.push("/admin/add-view-workdone")}>
          Add/View Workdone
          </Button>
        </Grid>
        <Grid item xs={12} sm={12} lg={4}></Grid>
