...
getChipData = () => {
 ...
 this.setState({frequencyChipData:chipData});
  ...
  selectSection = (index, section_id, sindex,standard) => {
    let chipData=[];
    chipData.push({ stdindex:index, std_id:section_id, secindex: sindex, label: standard });
    this.setState({frequencyChipData:chipData});
  }
      ...
      <Grid item xs={12} md={4} lg={3}>
        ...
        <Card className="card-box p-3  mb-4">
         <Grid container spacing={4}>
             ...
             {this.state.markdateConfirm && <Grid item xs={12} sm={12} md={6}  className="customDiv">
             <Grid container>
            ...
            />
               ...
               <OutlinedDiv label="Select session">
                 <Paper component="ul">
                 {this.state.attendanceType == "onceaday" && <li>
            <Chip
            className="m-2"
            variant="outline"
            color="primary"
            ...
            {this.state.attendanceType == "twiceaday" && <div><li>
            <FormControlLabel
                     control={
                       <Radio
            ...
            {this.state.attendanceType == "periodwise" && <div><li>
            <FormControlLabel
                     control={
                       <Radio
                       checked={this.state.selectedSession === "session1"}
         ...
         {this.state.frequencyChipData.length > 0  &&  <Grid container spacing={4}>
...
{AuthHelper('Attendance','can_create') &&    <Grid container spacing={4}>
      ...
      <Grid item xs={12} md={4} lg={6} className="text-right">
        ...
        {this.state.marking_type == "regular_student_attendance" && <Grid container spacing={4} justify="center">
        <Grid item xs={12} md={8} lg={10}>
        <Card className="card-box pt-2 pb-1 pl-2 mb-4">
         <Grid container spacing={4}>
         <Grid item xs={12} sm={12} md={3} className="pickerGrid">
             ...
             {this.state.markdateConfirm && <Grid item xs={12} sm={12} md={2} className="pickerGrid customDiv">
             
               <OutlinedDiv label="Standard">
                 <Paper component="ul">
                 {this.state.frequencyChipData.map((data,i) => {
            return (
            <li key={data.secindex}>
            ...
            variant="outline"
            color="secondary"
            label={this.state.frequencyChipData.length > 0 ? "Change" : "Standard"}
            />
            </li>
                 </Paper>
                 </OutlinedDiv>
...
<Grid item xs={12} sm={12} lg={2}>
          <FormControl fullWidth>
                 <TextField
                    ...
                    onChange={(event,child)=>{this.setState({selectedPeriod:child.props.id,mappedAttendance:[]}); this.getPeriodSubjects()}}
                    variant="outlined">
                    {this.state.periodList && this.state.periodList.map(option => (
          ...
          <Grid item xs={12} sm={12} lg={3}>
               <FormControl fullWidth>
                 <TextField
                    ...
                    onChange={(event,child)=>    this.setState({selectedSubject:child.props.id, selectedSubjectName:child.props.name, mappedAttendance:[]})}
                    variant="outlined">
          ...
          <Grid item xs={12} sm={12} lg={1} className="m-2 pickerGrid">
...
<CardActions stats style={{marginTop:0}}>
  <Grid container spacing={4}>
      ...
      {AuthHelper('Attendance','can_export') &&  <Button className="mr-2"  variant="outlined" color="secondary">
        ...
        {this.state.marking_type == "regular_staff_attendance" && <Grid container spacing={4}  justify="center">
        <Grid item xs={12} md={8} lg={10}  className="pickerGrid">
        <Card className="card-box pt-2 pb-1 pl-2 mb-4">
         <Grid container spacing={4} justify="center">
