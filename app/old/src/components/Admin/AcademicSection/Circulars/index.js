...
class Student extends React.Component {
  ...
  getDashboardDetails() {
    ...
    new Service().apiCall('circulars/getCircularDashboardDetails',postData).then(response => {
    ...
    <PageTitle
           ...
           <Grid item xs={12} sm={6} lg={3}>
            ...
            {/* <Grid item xs={12} sm={6} lg={3}>
              <div
                ...
                <div className="w-100 text-center">
                  <div className="display-3  font-weight-400">
                  {this.state.dashboardDetails['staff']}
                  </div>
                  <div className="mt-2 mb-2" />
                  <div className="font-weight-400 font-size-sm text-uppercase">
                      Staff
            ...
            <Grid item xs={12} sm={6} lg={3}>
              <div
                ...
                <div className="w-100 text-center">
                  <div className="display-3  font-weight-400">
                  {this.state.dashboardDetails['student']}
                  </div>
                  <div className="mt-2 mb-2" />
                  <div className="font-weight-400 font-size-sm text-uppercase">
                  Students
            ...
            <Grid item xs={12} sm={6} lg={3}>
              <div
                ...
                <div className="w-100 text-center">
                  <div className="display-3  font-weight-400">
                  {this.state.dashboardDetails['common']}
                  </div>
                  <div className="mt-2 mb-2" />
                  <div className="font-weight-400 font-size-sm text-uppercase">
                  Common
      ...
      <Grid container spacing={2} justify="center">
        ...
        <Grid item xs={12} sm={12} lg={4}>
          <Button className="m-2 w-100 py-2 font-18" variant="contained" color="secondary" onClick={()=>this.props.history.push("/admin/add-view-circular")}>
          {AuthHelper('Circulars','can_create') ? "Upload/View Circular" : "View CIrculars"}
          </Button>
        </Grid>
        <Grid item xs={12} sm={12} lg={4}></Grid>
      </Grid>
