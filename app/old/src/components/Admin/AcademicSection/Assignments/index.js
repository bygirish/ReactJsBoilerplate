...
class Student extends React.Component {
  ...
  getDashboardDetails() {
    ...
    new Service().apiCall('assignments/getAssignmentDashboardDetails',postData).then(response => {
    ...
    <PageTitle
      ...
      <Grid container spacing={4}>
        ...
        <Grid item xs={12} sm={12} lg={4}>
          <Button className="m-2 w-100 py-2 font-18" variant="contained" color="secondary" onClick={()=>this.props.history.push("/admin/add-view-assignment")}>
          {AuthHelper('Assignment','can_create') ? "Create/View Assignment" : "View Assignments"}
          </Button>
        </Grid>
        <Grid item xs={12} sm={12} lg={4}></Grid>
      </Grid>
