...
class TcReportManagement extends React.Component {
    ...
    getReportData = event =>{
        ...
        // return false;
        new Service().apiCall('ReportManagement/getTcReportData',postData).then(response => {
...
export default connect(mapStateToProps, mapDispatchToPros)(TcReportManagement);
