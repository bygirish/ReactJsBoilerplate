...
class AttendanceReportManagement extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            dialogOpen:true,
    ...
    selectReportType = (value) => {
        ...
        //console.log('hgf'+this.state.frequencySettings);
    }
    ...
    getReportData = event =>{
        ...
        // return false;
        new Service().apiCall('ReportManagement/getAttendanceData',postData).then(response => {
                                ...
                                {this.state.ReportDetail != '' && <>
                                    <Grid item xs={12} sm={12} lg={12} className="mb-3">
                                        ...
                                        <div className="mt-4 text-right">
                                            <Button className="m-2" variant="contained" color="secondary" href={Config.url+"/ReportManagement/excelStudentAttendanceMonthlyReport?id_organization="+this.props.data.selectedOrganizationId+"&id_institute="+this.props.data.selectedInstitutionId+"&id_board="+this.state.selectedBoard+"&id_academicyear="+this.state.selectedAcademicYear+"&reportType="+this.state.reportType+"&standard_id="+this.state.joiningStandardName+"&fromDate="+this.state.fromDate+"&toDate="+this.state.toDate}>Export</Button>
                                        </div>  
...
export default connect(mapStateToProps, mapDispatchToPros)(AttendanceReportManagement);
