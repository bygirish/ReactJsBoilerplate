...
class UploadStaffs extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      showStatus:'all',
...
showError = (error) => {
  ...
  submit = e =>{ 
    ...
    new Service().apiCall('StaffDetails/excelStaffsUpload', formData,
    {
      headers: {
                ...
                <Toolbar className="w-100">
                    <Grid container>
                        <Grid item xs={12} lg={12} className="d-flex">
                            ...
                            <Typography variant="h4" className="p-12">Upload Staffs</Typography>
                        </Grid>
                    </Grid>
                </Toolbar>
            </AppBar>
                                        ...
                                        <form onSubmit={this.submit.bind(this)} autoComplete="off">                                        
                                          <Grid container>
                                            <Grid item xs={12} sm={12} md={6} className="text-left">
                                              <Button variant="outlined" color="primary" onClick={()=>this.exportStaffSample(Config.url+"/StaffDetails/excelStaffSample?id_institute="+this.props.data.selectedInstitutionId+"&id_board="+this.props.data.selectedBoardId+"&id_academicyear="+this.props.data.selectedAcademicId)}>Sample Excel Format</Button>
...
UploadStaffs.propTypes = {
  classes: PropTypes.object.isRequired
};
export default connect(mapStateToProps, mapDispatchToPros)(UploadStaffs);
