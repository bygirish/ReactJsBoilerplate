...
class Student extends React.Component {
  ...
  getDashboardDetails() {
    ...
    new Service().apiCall('Alumnus/getDashboardDetails',postData).then(response => {
    ...
    <Animated  animationIn="slideInRight" animationOut="slideOutLeft"> 
      ...
      <Grid container spacing={5} justify="center">
        <Grid item xs={12} sm={12} lg={4}>
          <Button className="m-2 w-100 py-2 font-18" variant="contained" color="secondary" onClick={()=>this.props.history.push("/admin/add-alumni")}>
          Add New Alumni
          </Button>
        </Grid>
        <Grid item xs={12} sm={12} lg={4}>
          <Button className="m-2 w-100 py-2 font-18" variant="contained" color="secondary" onClick={()=>this.props.history.push("/admin/view-alumni")}>
          View/Edit Alumni
          </Button>
        </Grid>
      </Grid>
