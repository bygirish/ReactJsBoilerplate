...
class CancelScheduledDataManagement extends React.Component {
    constructor(props) {
        super(props);
    ...
    cancelScheduleVisit = event =>{
        ...
        let headingStatus = "Scheduled Visit is cancelled successfully!";
        ...
        //return false;
        new Service().apiCall('VisitorManagement/cancelScheduledData',postData).then(response => { 
            ...
            if (response.status==200 && response.data!='') {
                ...
                setTimeout(() => {
                    ...
                    this.props.history.push("/admin/scheduled-visitors");
                }, 2000) 
...
export default connect(mapStateToProps, mapDispatchToPros)(CancelScheduledDataManagement);
