...
class AllVisitorManagement extends React.Component { 
  constructor(props) {
    super(props);
    this.state = {
      showStatus:'all',
  ...
  getVisitorData = (type) => {
    ...
    new Service().apiCall('VisitorManagement/getAllVisitorData',postData).then(response => { 
                                    ...
                                    <Card className="card-box  mb-4 p-3 customNoData">
                                        ...
                                        <Grid container className="mt-2">
                                          <Grid item xs={12} sm={12} md={12} className="text-right">
                                            <Button className="m-2" variant="outlined" color="secondary" href={Config.url+"/VisitorManagement/excelVisitors?id_institute="+this.props.data.selectedInstitutionId+"&id_board="+this.state.selectedBoard+"&id_academicyear="+this.state.selectedAcademicYear}>Export</Button>
                                          </Grid>
                                        </Grid>
                                    </Card>
                                </Grid>
...
export default connect(mapStateToProps, mapDispatchToPros)(AllVisitorManagement);
