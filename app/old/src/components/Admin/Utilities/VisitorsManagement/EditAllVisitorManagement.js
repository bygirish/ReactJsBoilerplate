...
class EditAllDataManagement extends React.Component {
    constructor(props) {
        super(props);
    ...
    updateVisitorMaster = event =>{
        ...
        // return false;
        new Service().apiCall('VisitorManagement/updateVisitorData',postData).then(response => {
        ...
        new Service().apiCall('VisitorManagement/getAllVisitorData',postData).then(response => { 
          ...
          if (response.status==200 && response.data!='') {
            ...
            this.setState({                 
                ...
                existingPerson:response.data[0].person,
    ...
    //GET STAFF LIST AUTOCOMPLETE SUGGESTION
...
export default connect(mapStateToProps, mapDispatchToPros)(EditAllDataManagement);
