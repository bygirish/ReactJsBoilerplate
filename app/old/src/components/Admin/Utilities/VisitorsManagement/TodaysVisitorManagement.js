...
class TodaysVisitorManagement extends React.Component { 
  constructor(props) {
    super(props);
    this.state = {
      showStatus:'all',
                                ...
                                <Grid item xs={12} md={12} lg={12}>
                                    <Card className="card-box  mb-4 p-3 customNoData">
                                        ...
                                        <Grid container className="mt-2">
                                          ...
                                          <Button className="m-2" variant="outlined" color="secondary" href={Config.url+"/VisitorManagement/excelTodaysVisitors?id_institute="+this.props.data.selectedInstitutionId+"&id_board="+this.state.selectedBoard+"&id_academicyear="+this.state.selectedAcademicYear}>Export</Button>
                                          </Grid>
                                        </Grid>
                                    </Card>
                                </Grid>
...
export default connect(mapStateToProps, mapDispatchToPros)(TodaysVisitorManagement);
