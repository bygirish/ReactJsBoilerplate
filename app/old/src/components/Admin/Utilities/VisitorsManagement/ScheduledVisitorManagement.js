                                    ...
                                    <Card className="card-box  mb-4 p-3 customNoData">
                                                                    ...
                                                                    <>
                                                                      <Tooltip id="tooltip-top" title="View" placement="top" >
                                                                        <Button
                                                                          className="m-2"
                                                                          simple
                                                                          onClick={()=>this.props.history.push("/admin/edit-scheduled-visit/"+original.id)}
                                                                          color="secondary"
                                                                          className="edit"
                                                                          >
                                                                          <EditIcon/>
                                                                      ...
                                                                      <Tooltip id="tooltip-top" title="View" placement="top" > 
                                                                        <Button
                                                                          className="m-2"
                                                                          simple
                                                                          onClick={()=>this.props.history.push("/admin/cancel_schedule-visit/"+original.id)}
                                                                          color="secondary"
                                                                          className="edit"
                                                                          >
                                                                          <CloseIcon/>
                                        ...
                                        <Grid container className="mt-2">
                                          <Grid item xs={12} sm={12} md={12} className="text-right">
                                            <Button className="m-2" variant="outlined" color="secondary" href={Config.url+"/VisitorManagement/excelScheduledVisits?id_institute="+this.props.data.selectedInstitutionId+"&id_board="+this.state.selectedBoard+"&id_academicyear="+this.state.selectedAcademicYear}>Export</Button>
                                          </Grid>
                                        </Grid>
                                    </Card>
                                </Grid>
