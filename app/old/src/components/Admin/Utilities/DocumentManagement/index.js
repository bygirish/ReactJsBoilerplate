...
class Student extends React.Component {
  ...
  getDashboardDetails() {
    ...
    new Service().apiCall('DocumentManagements/getDocumentationDashboardDetails',postData).then(response => {
  ...
  return (
    ...
    <PageTitle
        ...
        titleHeading="Document Management"
        titleDescription=""
        {...this.props}
      /> 
           ...
           <Grid item xs={12} sm={6} lg={3}>
            ...
            <Grid item xs={12} sm={6} lg={3}>
              <div
                ...
                <div className="w-100 text-center">
                  <div className="display-3  font-weight-400">
                  {this.state.dashboardDetails.incustody}
                  </div>
                  <div className="mt-2 mb-2" />
                  <div className="font-weight-400 font-size-sm text-uppercase">
                  In Custody
            ...
            <Grid item xs={12} sm={6} lg={3}>
              <div
                ...
                <div className="w-100 text-center">
                  <div className="display-3  font-weight-400">
                  {this.state.dashboardDetails.returned}
                  </div>
                  <div className="mt-2 mb-2" />
                  <div className="font-weight-400 font-size-sm text-uppercase">
                  Returned
      ...
      {AuthHelper('Document Management','can_create') && <Grid container spacing={2} justify="center">
        <Grid item xs={12} sm={12} lg={4}></Grid>
        <Grid item xs={12} sm={12} lg={4}>
          <Button className="m-2 w-100 py-2 font-18" variant="contained" color="secondary" onClick={()=>this.props.history.push("/admin/add-view-docket")}>
          Add/View Docket
          </Button>
        </Grid>
        <Grid item xs={12} sm={12} lg={4}></Grid>
