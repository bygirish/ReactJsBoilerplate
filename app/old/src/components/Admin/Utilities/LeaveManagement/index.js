...
class Student extends React.Component {
  ...
  return (
    ...
    <PageTitle
           ...
           <Grid item xs={12} sm={6} lg={3}>
              <div
                ...
                <div className="w-100 text-center">
                  ...
                  {this.state.dashboardDetails['total']?this.state.dashboardDetails['total']:0}
                  </div>
     ...
     {AuthHelper('Leave Management','can_create') &&  this.props.data.usertype == "admin" &&   <Grid item xs={12} sm={12} lg={4}>
          <Button className="m-2 w-100 py-2 font-18" variant="contained" color="secondary" onClick={()=>this.props.history.push("/admin/leave-types")}>
          Leave Types
          </Button>
        </Grid>}
        {this.props.data.usertype == "staff" && <Grid item xs={12} sm={12} lg={4}>
          <Button className="m-2 w-100 py-2 font-18" variant="contained" color="secondary" onClick={()=>this.props.history.push("/admin/apply-leave")}>
          Apply Leave
          </Button>
        </Grid>}
        <Grid item xs={12} sm={12} lg={4}>
          <Button className="m-2 w-100 py-2 font-18" variant="contained" color="secondary" onClick={()=>this.props.history.push("/admin/view-applications")}>
          View Applications
          </Button>
        </Grid>
