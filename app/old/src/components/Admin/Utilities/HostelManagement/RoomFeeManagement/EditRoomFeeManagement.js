...
class EditHostelRoomFeeManagement extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      showStatus:'all',
      ...
      checked: [],
      groupCount:[],
      holidays:[{id:1, room_no:'1', bed_no:'1'}],
      message: '',
      groupInsert :[],
      classwiseStudent : [],
      startdate:new Date(),
...
export default connect(mapStateToProps, mapDispatchToPros)(EditHostelRoomFeeManagement);
